...
/**
 * Chromium misses the adjacent word when a secondary-click lands on its rendered
 * caret, so select that word long enough for Electron's spellchecker hit test.
 */
